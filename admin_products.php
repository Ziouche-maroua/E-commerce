...
<section class="add-products py-12">
   ...
   <form action="" method="post" enctype="multipart/form-data" class="max-w-lg mx-auto bg-white p-8 rounded-lg shadow-lg">
      ...
      <input type="text" name="name" class="box w-full p-3 border border-gray-300 rounded-lg mb-4" placeholder="Enter product name" required>
      <input type="number" min="0" name="price" class="box w-full p-3 border border-gray-300 rounded-lg mb-4" placeholder="Enter product price" required>
      <input type="file" name="image" accept="image/jpg, image/jpeg, image/png" class="box w-full p-3 border border-gray-300 rounded-lg mb-4" required>
